...
public class SpriteAnimation_UI_Stepper : SpriteAnimation_Stepper
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(SpriteAnimation_UI_Stepper))]
public class SpriteAnimation_UI_StepperEditor : Editor
{
	public override void OnInspectorGUI()
	{
		...
		{
			(target as SpriteAnimation_UI_Stepper).SetAnimatedSpritesToDefault();
		}
